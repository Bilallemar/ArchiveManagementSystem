...
import { createAnnualReportInfo } from "../../../services/StorageManagement/AnnualReportInfoApi";
import React, { useState } from "react";
import PageBreadcrumbs from "../../Breadcrumbs/PageBreadcrumbs";
import SaveIcon from "@mui/icons-material/Save";
import { provinces, provincesWithDistricts } from "../../../Data/Afghanistan";

export default function AddAnnualReportInfo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createAnnualReportInfo(formData);
