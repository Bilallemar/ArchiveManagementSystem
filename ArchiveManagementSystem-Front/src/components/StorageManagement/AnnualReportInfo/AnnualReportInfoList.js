...
import { getAnnualReportsInfo } from "../../../services/StorageManagement/AnnualReportInfoApi";
import { deleteAnnualReportInfo } from "../../../services/StorageManagement/AnnualReportInfoApi";
import ViewAnnualReportInfo from "./ViewAnnualReportInfo";
...
export default function AnnualReportInfoList() {
  ...
  const loadReport = useCallback(async () => {
    try {
      const response = await getAnnualReportsInfo(searchTerm, field);
  ...
  const handleNewReport = () => {
    navigate("/annual-reports-info/add-annual-report-info");
  };

  const handleDelete = async () => {
    try {
      await deleteAnnualReportInfo(selectedReport.id);
      loadReport();
