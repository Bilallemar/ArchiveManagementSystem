...
import { deleteReceipt } from "../../../services/StorageManagement/ReceiptsApi";
...
export default function ReceiptsList() {
  ...
  const loadReceipts = useCallback(async () => {
    try {
      const response = await getReceipts(searchTerm, field);
        ...
        >
          ...
          >
            ...
            <Filter
              ...
              fields={[
                { value: "serialNumber", label: "سریال نمبر" },
                { value: "archiveNumber", label: "آرشیف نمبر" },
                { value: "department", label: "شعبه" },
                { value: "recipient", label: "مرسل" },
                { value: "sender", label: "مرسل الیه" },
              ]}
            />
