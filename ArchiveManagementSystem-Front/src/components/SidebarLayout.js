...
// // const groupNavItems = (items, isAdmin, text) => {
// //   const grouped = {
// //     dashboard: [],
// //     archive: [],
// //     hifziya: [],
...
//   } = useMyContext();
//   const navigationItems = getNavigationItems();
//   const groupedNav = groupNavItems(navigationItems, isAdmin, text);
...
//               }}
//             >
//               <MenuItem value="ps">{text.languagePashto}</MenuItem>
//               <MenuItem value="fa">{text.languageDari}</MenuItem>
//               <MenuItem value="en">{text.languageEnglish}</MenuItem>
//             </Select>
//           </FormControl> */}
//           {/* Language Switcher */}
//           <FormControl
...
//   // Grouping function (moved here for language update)
//   const groupNavItems = (items, isAdmin, text) => {
//     const grouped = { dashboard: [], archive: [], hifziya: [], makzan: [] };
...
//   // Compute groupedNav dynamically so it updates when language changes
//   const groupedNav = React.useMemo(
//     () => groupNavItems(navigationItems, isAdmin, text),
