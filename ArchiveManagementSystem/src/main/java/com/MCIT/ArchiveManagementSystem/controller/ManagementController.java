...
//         // Regular users only see their management
...
//             // Check if user is trying to access their own management
...
//         // Only admin can delete managements
//         boolean isAdmin = userDetails.getAuthorities().stream()
//                 .anyMatch(auth -> auth.getAuthority().equals("ROLE_ADMIN"));
