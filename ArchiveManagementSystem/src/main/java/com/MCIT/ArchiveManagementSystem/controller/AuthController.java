...
public class AuthController {
 ...
 @PostMapping("/public/signin")
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        // Assign management based on email domain or managementId
        if (signUpRequest.getManagementId() != null) {
            Management management = managementRepository.findById(signUpRequest.getManagementId())
                    .orElseThrow(() -> new RuntimeException("Error: Management not found."));
