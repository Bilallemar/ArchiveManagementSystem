...
//     // Absolute directory for file storage
//     private String fileuploadDirectory = "C:/Users/IT/OneDrive/Desktop/MyProject/ArchiveFullStackProject/uploads/";

//     // Base URL for accessing files from frontend
//     @Value("${spring.file.directory}")
//     private String fileBaseUrl = "http://localhost:8081/uploads/";
...
//             String filePath = Paths.get(fileuploadDirectory, uniqueFileName).toString();
...
//             // Return public URL instead of absolute path
//             return fileBaseUrl + uniqueFileName;
